...
(function(){
  ...
  <div id="page_egress" class="page-content" style="display:none;">
    ...
    <!-- 出站模块：出口实例卡片区（与主页"出口实例"模块视觉一致：铺满 + 扁平标题 + 8px 间距） -->
    <div id="egress_module_card" style="margin-bottom: 24px; background: var(--bg-surface, #f8fafc); border: 1px solid var(--border-color, #e2e8f0); border-radius: 12px; padding: 16px 20px;">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;">
        <span style="font-size:14px;font-weight:600;color:var(--text-primary);display:flex;align-items:center;gap:8px;">
